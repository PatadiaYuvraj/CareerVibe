...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('company.dashboard') }}" class="logo d-flex align-items-center">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('company.dashboard') }}">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('company.logout') }}">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('company.dashboard') }}">
                    <span>Dashboard</span>
                </a>
            </li>
            <hr>

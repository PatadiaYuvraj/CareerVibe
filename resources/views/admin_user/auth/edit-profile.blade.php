                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('admin_user.editProfile') }}">
                                        Edit Profile
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content pt-2">
                                <div class="profile-overview">
                                    ...
                                    <form action="{{ route('admin_user.updateProfile') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin_user.dashboard') }}" type="submit"

                ...
                <div class="card-header pagetitle">
                    ...
                    <div class="float-end">
                        @if (count($notifications) > 0)
                            <a href="{{ route('user.notification.readAll') }}" class="btn btn-sm btn-primary">Mark All As
                                Read</a>
                            <a href="{{ route('user.notification.deleteAll') }}" class="btn btn-sm btn-danger">Delete All</a>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @forelse ($notifications as $notification)
                                <tr>
                                    ...
                                    <td class="@if ($notification['read_at'] != null) text-muted @endif">
                                        ...
                                        @else
                                            <a href="{{ route('user.notification.unread', $notification['id']) }}"

...
<div class="card mb-3">
    <div class="card-body">
        ...
        <form class="row g-3" action="{{ route('user.doRegister') }}" method="POST">
            @csrf
            <div class="col-12">
                <label for="name" class="form-label">Name</label>
                <input type="text" name="name" class="form-control" placeholder="Enter Email" value="{{ old('name') }}" id="name">
                @error('name')

            ...
            <div class="card">
                <div class="card-header pagetitle">
                    <span class="h3 text-black">
                        Posts
                        <a href="{{ route('admin_user.post.create') }}" class="float-end btn btn-sm btn-primary">
                            <i class="bi-plus-lg">
                                Add Post
                            </i>
                        </a>
                    ...
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                            @forelse ($posts as $post)
                                <tr>
                                    <td>
                                        <a href="{{ route('admin_user.post.show', $post['id']) }}">
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex btn-group">
                                            <a href="{{ route('admin_user.post.edit', $post['id']) }}"
                                                class="btn btn-sm btn-outline-primary p-1">
                                                <i class="bi-pencil-square"></i>
                                            </a>
                                            <a href="{{ route('admin_user.post.delete', $post['id']) }}"

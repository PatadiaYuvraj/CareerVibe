                    ...
                    <div class="dropdown float-end">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                            ...
                            <li>
                                ...
                                "
                                    href="{{ route('user.job.index', ['type' => 'active']) }}">
                                    Active Jobs
                                </a>
                            </li>
                            <li>
                                ...
                                "
                                    href="{{ route('user.job.index', ['type' => 'applied']) }}">
                                    Applied Jobs
                                </a>
                            </li>
                            <li>
                                ...
                                "
                                    href="{{ route('user.job.index', ['type' => 'saved']) }}">
                                    Saved Jobs
                                </a>
                            </li>
                            <li>
                                ...
                                "
                                    href="{{ route('user.job.index', ['type' => 'featured']) }}">
                                    Featured Jobs
                                </a>
                            </li>
                            <li>
                                ...
                                "
                                    href="{{ route('user.job.index', ['type' => 'verified']) }}">
                                    Verified Jobs
                                </a>
                            </li>
                        </ul>

                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('admin_company.editProfileImage') }}">
                            ...
                            <div class="tab-content pt-2">
                                <div class="profile-overview">
                                    ...
                                    <form action="{{ route('admin_company.updateProfileImage') }}" method="POST"
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin_company.dashboard') }}"

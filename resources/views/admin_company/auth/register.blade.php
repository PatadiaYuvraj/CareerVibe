...
@section('content')
    <div class="card mb-3">
        <div class="card-body">
            ...
            <form class="row g-2" action="{{ route('admin_company.doRegister') }}" method="POST">
                @csrf
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    {{-- suggest password "regex:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$/" --}}
                ...
                <div class="col-12 text-center">
                    <p class="small mb-0">Already have an account?
                        <a href="{{ route('admin_company.login') }}">Log in</a>
                    </p>
                    <p class="small mb-0">

    ...
    <main id="main" class="main">
        <section class="section dashboard">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- Route::post('/comment/{id}/update/{comment_id}',  [UserUserController::class, "commentPostUpdate"])->name('admin_company.post.commentUpdate');  // comment update page --}}
                    <form action="{{ route('admin_company.post.commentUpdate', [$post['id'], $comment['id']]) }}"
                        method="POST">
                        @csrf
                        <div class="mb-3">

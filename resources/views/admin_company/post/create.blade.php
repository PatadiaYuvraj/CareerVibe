        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-header pagetitle">
                    ...
                    <a href="{{ route('admin_company.post.index') }}" class="float-end btn btn-sm btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('admin_company.post.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <a href="{{ route('admin_company.post.index') }}" class="btn btn-danger">Cancel</a>
                    </form>

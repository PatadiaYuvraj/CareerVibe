        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-header pagetitle">
                    ...
                    <a href="{{ route('admin_company.job.index') }}" class="float-end btn btn-sm btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('admin_company.job.store', $company['id']) }}" method="POST">
                        @csrf
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin_company.job.index') }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>

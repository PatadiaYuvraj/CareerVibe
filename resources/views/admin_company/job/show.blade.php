                ...
                <div class="card-header ">
                    <nav aria-label="breadcrumb" class="">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin_company.job.index') }}">Jobs</a></li>
                ...
                <div class="card-body">
                    <div class="col pt-3">
                        ...
                        <p class="lead position-relative">
                            <span class="badge bg-{{ $job['is_verified'] ? 'success' : 'danger' }}">
                        ...
                        <p class="lead">
                            <a class="btn btn-outline-primary btn"
                                href="{{ route('admin_company.job.edit', $job['id']) }}">Edit</a>
                        </p>
                    </div>
                    {{-- <hr />
                    <div class="col" style="">

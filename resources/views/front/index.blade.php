...
<body>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="button">
                                ...
                                <a href="javacript:" data-toggle="modal" data-target="#signup" class="btn">Sign
                                    Up</a>
                            </div>
                        </nav>
                        <!-- navbar -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".2s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-1.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">50</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".4s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-2.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">30</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".6s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-3.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">99</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".8s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-4.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">15</span>
                                <h3>Share Maeket Analysis</h3>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".2s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-5.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">20</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".4s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-6.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">19</span>
                                <h3>IT & Networing Sevices</h3>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".6s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-7.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">25</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="browse-jobs.html" class="single-cat wow fadeInUp" data-wow-delay=".8s">
                            <div class="top-side">
                                <img src="assets/images/jobs/category-8.jpg" alt="#" />
                            </div>
                            <div class="bottom-side">
                                <span class="available-job">40</span>
                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
                        <div calss="row">
                            <div calss="col-lg-6 col-12">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img" src="assets/images/about/small1.jpg"
                                            alt="#" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img mt-50" src="assets/images/about/small2.jpg"
                                            alt="#" />
                                    </div>
                                </div>
                            </div>
                            <div calss="col-lg-6 col-12">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img minus-margin" src="assets/images/about/small3.jpg"
                                            alt="#" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <!-- media body start -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="image">
                                <img src="assets/images/featured-job/img1.jpg" alt="#" />
                            </div>
                            <div class="content">
                                <h4><a href="job-details.html">Graphics Design</a></h4>
                                <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="feature">Featured</div>
                            <div class="image">
                                <img src="assets/images/featured-job/img2.jpg" alt="#" />
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="feature">Featured</div>
                            <div class="image">
                                <img src="assets/images/featured-job/img3.jpg" alt="#" />
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="feature">Featured</div>
                            <div class="image">
                                <img src="assets/images/featured-job/img4.jpg" alt="#" />
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="feature">Featured</div>
                            <div class="image">
                                <img src="assets/images/featured-job/img5.jpg" alt="#" />
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="feature">Featured</div>
                            <div class="image">
                                <img src="assets/images/featured-job/img6.jpg" alt="#" />
                            </div>
                            <div class="content">
    ...
    <section class="testimonials">
        <img class="patern1 wow fadeInRight" data-wow-delay=".3s" src="assets/images/testimonial/patern1.png"
            alt="#" />
        <img class="patern2 wow fadeInLeft" data-wow-delay=".5s" src="assets/images/testimonial/patern1.png"
            alt="#" />
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12">
                            ...
                            <div class="testimonial-slider">
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <h4 class="name">
                                            Naimur Rahman <span>CEO - Wpthemes Grid</span>
                                        </h4>
                                    </div>
                                </div>
                                <!--/ End Single Testimonial -->
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <h4 class="name">
                                            Goro Chala <span>CEO - Dream App</span>
                                        </h4>
                                    </div>
                                </div>
                                <!--/ End Single Testimonial -->

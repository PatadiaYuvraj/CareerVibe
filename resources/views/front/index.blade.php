...
<head>
    ...
    <title>JobGrids - Job Portal</title>
...
<body>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="button">
                                ...
                                <a href="" data-toggle="modal" data-target="#signup" class="btn">Sign
                                    Up</a>
                            </div>
                        </nav>
                        <!-- navbar -->
                            ...
                            <div class="col-lg-6 co-12">
                                <div class="inner-content">
                                    <div class="hero-text">
                                        ...
                                        <p class="wow fadeInUp" data-wow-delay=".5s">Creating a beautiful job website
                                            is
                                            not
        ...
        <div class="container">
            ...
            <div class="cat-head">
                <div class="row">
                    ...
                    {{-- <div class="col-lg-3 col-md-6 col-12">
                        <a href="" class="single-cat wow fadeInUp" data-wow-delay=".4s">
                            <div class="top-side">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img mt-50"
                                            src="{{ asset('front/images/about/small2.jpg') }}" alt="#">
                                    </div>
                                </div>
                            </div>
                            <div calss="col-lg-6 col-12">
    ...
    {{-- recent jobs section or latest jobs section --}}
    <!-- Start Find Job Area -->
                                ...
                                <div class="single-footer newsletter">
                                    ...
                                    <form action="https://demo.graygrids.com/themes/jobgrids/mail/mail.php"
                                        ...
                                        <input name="EMAIL" placeholder="Your email address" class="common-input"
                                            ...
                                            type="email">
                                        <div class="button">
                                            <button class="btn">Subscribe Now! <span

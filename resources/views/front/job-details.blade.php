                                ...
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item"><a href="#" class="active">Pages</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="job-details.html" class="active">Job Details</a></li>
                    ...
                    <div class="job-details-inner">
                        <div class="job-details-head row mx-0">
                            <div class="company-logo col-auto">
                                <a href="#" style="border-radius: 4px; overflow: hidden;"><img
                                        src="assets/images/universal-image/job-details.png" alt="Company Logo"></a>
                            </div>
                            ...
                            <div class="content col">
                                ...
                                <ul class="meta">
                                    <li><strong class="text-primary"><a
                                                href="http://www.graygrids.com/">GrayGrids</a></strong>
                                    </li>
                            ...
                            <div class="inner">
                                <div class="row m-n2 button">
                                    <div class="col-xl-auto col-lg-12 col-sm-auto col-12 p-2">
                                        <a href="bookmarked.html" class="d-block btn"><i
                                                class="fa fa-heart-o mr-1"></i> Save Job</a>
                                    </div>
                                    <div class="col-xl-auto col-lg-12 col-sm-auto col-12 p-2">
                            ...
                            <div class="inner">
                                ...
                                <div class="mapouter">
                                    <div class="gmap_canvas"><iframe width="100%" height="300" id="gmap_canvas"
                                            ...
                                            marginwidth="0"></iframe><a href="https://123movies-to.com/">123movies old
                                            site</a>
                                        <style>
                                            .mapouter {
                                                position: relative;
